...
function setSelfie(state = '', action) {
  switch ( action.type ){
    case 'setSelfie': 
      return  state = action.value;
    default: return state;
...
function setPhotoCMND(state = '', action) {
  switch ( action.type ){
    case 'setPhotoCMND': 
      return  state = action.value;
    default: return state;
...
function setNameImageFirebase(state = '', action) {
  switch ( action.type ){
    case 'setNameImageFirebase': 
      return  state = action.value;
    default: return state;
  }
}
...
let store = createStore(combineReducers({ 
  ...
  Money: setMoney,
  Mounth: setMounth,
  PhotoSelfie: setSelfie,
  PhotoCMND: setPhotoCMND,
  NameImageFirebase: setNameImageFirebase,
}));
